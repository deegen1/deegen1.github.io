...
DrawPath
	Calculate optimal control point distance for arcto().
...
DrawImage
	...
	Calculate actual start and end y. Remove inverse AABB test.
	Get rid of abs(), floor(), ceil().
	...
	Does readcount go to 0 because the pixel area*.4999 is too small?
	Make smaller.
